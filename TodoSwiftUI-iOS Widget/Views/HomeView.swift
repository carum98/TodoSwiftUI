...
struct HomeView_Previews: PreviewProvider {
    static var previews: some View {
        let lists = [
            ...
            ListModel(id: 6, name: "Work", color: "#FF0000"),
            ListModel(id: 7, name: "University", color: "#FFFF00"),
            ListModel(id: 8, name: "Development", color: "#FF00FF"),
            ListModel(id: 9, name: "Food", color: "#00F2F"),
            ListModel(id: 10, name: "Tools", color: "#F02240"),
        ]
